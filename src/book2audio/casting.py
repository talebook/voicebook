...
FEMALE_NOUNS = "女孩|女子|少女|姑娘|女声|女聲|夫人|小姐|婶|嬸|姨娘|丫头|丫頭|女童|老妪|老嫗|妇人|婦人|母亲|母親|妈妈|媽媽|婆婆|奶奶|姣好|肤白|膚白|白嫩|娇|嬌|裙|钗|釵|妆|妝|夫君|娘子"
MALE_NOUNS = "男孩|男子|少年郎|汉子|漢子|公子|男声|男聲|老汉|老漢|老者|大叔|小伙|男童|父亲|父親|爸爸|爷爷|爺爺|道士|道长|道長|老道|胡须|鬍鬚|络腮|絡腮|先生|長兄|长兄|大爺|大爷|相公|和尚|祖師|祖师|買辦|买办"
...
# 状态 → 未来轻量 TTS 控制文本（当前 edge 路径主要使用 rate/pitch）
STATE_INSTRUCT = {
